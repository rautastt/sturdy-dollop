...
const FROM = process.env.EMAIL_FROM || 'REBLOX <noreply@reblox.local>';
...
async function sendVerificationEmail(email, username, token) {
  ...
  await maybeSend(email, 'Verify your REBLOX email', `
    <div style="font-family:sans-serif;max-width:520px;margin:0 auto;background:#1e1f22;color:#dcddde;padding:32px;border-radius:12px;">
      <h1 style="color:#5865f2">REBLOX</h1>
...
async function sendPasswordResetEmail(email, username, token) {
  ...
  await maybeSend(email, 'Reset your REBLOX password', `
    <div style="font-family:sans-serif;max-width:520px;margin:0 auto;background:#1e1f22;color:#dcddde;padding:32px;border-radius:12px;">
      <h1 style="color:#5865f2">REBLOX</h1>
...
async function sendChangeEmailVerification(newEmail, username, token) {
  ...
  await maybeSend(newEmail, 'Confirm your new REBLOX email', `
    <div style="font-family:sans-serif;max-width:520px;margin:0 auto;background:#1e1f22;color:#dcddde;padding:32px;border-radius:12px;">
      <h1 style="color:#5865f2">REBLOX</h1>
